...
func (x *RandomChatMessage) Reset() {
	*x = RandomChatMessage{}
...
func (x *RandomChatMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RandomChatMessage) ProtoMessage() {}

func (x *RandomChatMessage) ProtoReflect() protoreflect.Message {
	mi := &file_chat_message_proto_msgTypes[0]
...
// Deprecated: Use RandomChatMessage.ProtoReflect.Descriptor instead.
func (*RandomChatMessage) Descriptor() ([]byte, []int) {
	return file_chat_message_proto_rawDescGZIP(), []int{0}
}

func (x *RandomChatMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RandomChatMessage) GetAge() int32 {
	if x != nil {
		return x.Age
	}
	return 0
...
var file_chat_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x39, 0x0a, 0x11, 0x52, 0x61, 0x6e, 0x64,
	0x6f, 0x6d, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a,
...
var file_chat_message_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_chat_message_proto_goTypes = []interface{}{
	(*RandomChatMessage)(nil), // 0: pb.RandomChatMessage
}
...
func file_chat_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chat_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RandomChatMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
